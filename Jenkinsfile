            ...
            steps {
                timestamps {
                    script {
                        ...
                        returnCode = utils.cmd("runner vanessa --settings tools/VBParams.json ${platform1cLine} --ibconnection \"${testbaseConnString}\" ${admin1cUsrLine} ${admin1cPwdLine} --pathvanessa tools/add/vanessa-automation.epf")
